...
pygame.display.init()
pygame.font.init()
import shader as shader_module
...
pygame.display.set_caption("MandebrotGLSL - Ian Mallett - v.5.00 - 2013")
...
mandelbrot_shader.print_errors()
...
def draw():
    ...
    shader_module.Shader.use(mandelbrot_shader)
